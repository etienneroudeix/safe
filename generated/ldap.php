 ...
 * @param  $base The base DN for the directory.
 * @param string $filter 
 ...
 * 
 */
function ldap_list( $ldap,  $base, string $filter, array $attributes = [], int $attributes_only = 0, int $sizelimit = -1, int $timelimit = -1, int $deref = LDAP_DEREF_NEVER,  $controls = null)
{
    error_clear_last();
 ...
 * 
 */
function ldap_read( $ldap,  $base, string $filter, array $attributes = [], int $attributes_only = 0, int $sizelimit = -1, int $timelimit = -1, int $deref = LDAP_DEREF_NEVER,  $controls = null)
{
    error_clear_last();
 ...
 * 
 */
function ldap_search( $ldap,  $base, string $filter, array $attributes = [], int $attributes_only = 0, int $sizelimit = -1, int $timelimit = -1, int $deref = LDAP_DEREF_NEVER,  $controls = null)
{
    error_clear_last();
